...
class MonteCarloPlayer(Player):
    ...
    def run_episode(self, index):
        ...
        while not game.game_over:
            ...
            self.N[dealers_first_card - 1][self.current_total - 1][self.number_of_aces_used][action] += 1
            alpha = 1. / self.N[dealers_first_card - 1][self.current_total - 1][self.number_of_aces_used][action]
            new_q[dealers_first_card - 1][self.current_total - 1][self.number_of_aces_used][action] += \
                alpha * (reward - self.Q[dealers_first_card - 1][self.current_total - 1][self.number_of_aces_used][action])
